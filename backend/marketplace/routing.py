...
from .consumers import ProductCreateConsumer, ProductListConsumer,ProductViewAndRatingUpdateConsumer, ProductDeleteConsumer,ProductCategory,ProductUpdateConsumer
